...
export default function RoomPage() {
  ...
  const emulatorSrc = isAmigaAga
    ...
    : isSegaConsole ? `/megadrive/launcher.html?system=${isMasterSystem ? 'mastersystem' : 'megadrive'}&v=2026-06-22-3` : isNes ? '/nes/launcher.html?v=2026-06-19-3' : isSnes ? '/snes/launcher.html?v=2026-06-01-2' : isPcEngine ? '/pcengine/launcher.html?v=2026-06-14-2' : isPlayStation ? '/playstation/launcher.html?v=2026-06-14-3' : isC64 ? '/c64/launcher.html?v=2026-06-13-2' : isAtariSt ? '/atarist/launcher.html?v=2026-06-21-3' : isArcade ? '/arcade/launcher.html?v=2026-06-23-1' : isSpectrum ? '/spectrum/index.html?v=2026-06-30-3' : isCpcPinball ? '/emulator-pinball-cpcbox/index.html?v=2026-06-19-7' : '/emulator/index.html?v=2026-06-01-1';
  ...
  const sendLocalJoystickMask = useCallback((mask) => {
    ...
    if (isHost) {
      ...
      if (!isAmigaFamily && !isSegaConsole && !isNes && !isSnes && !isPcEngine && !isPlayStation && !isC64 && !isAtariSt && !isArcade && !isCpcPinball) {
  ...
  }, [activePartyPlayer, addInputDebug, addLog, forwardExtraButtonAsKey, forwardInputToEmulator, forwardJoystickMaskAsKeys, isAmigaFamily, isArcade, isC64, isCpcParty, isNes, isPcEngine, isPlayStation, isSegaConsole, isSnes, releaseCpcPartySharedInput]);
  ...
  async function resetHostEmulator() {
    ...
    const type = isAmiga || isAmigaLink
      ...
      : isAmigaAga
        ? 'amiga_aga_reset'
      : isSegaConsole ? 'megadrive_reset' : isNes ? 'nes_reset' : isSnes ? 'snes_reset' : isPcEngine ? 'pcengine_reset' : isPlayStation ? 'playstation_reset' : isC64 ? 'c64_reset' : isAtariSt ? 'atarist_reset' : isArcade ? 'arcade_reset' : isSpectrum ? 'spectrum_reset' : 'amstrad_reset';
