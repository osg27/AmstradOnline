(function () {
  ...
  function configureEmulator(fileName, romUrl) {
    ...
    window.EJS_biosUrl = '/atarist/tos.img';
    ...
    window.EJS_paths = {
      ...
      'hatari-wasm.data': '/emulatorjs/data/cores/hatari-wasm.data?v=atarist-2026-06-20-1',
      'hatari-legacy-wasm.data': '/emulatorjs/data/cores/hatari-legacy-wasm.data?v=atarist-2026-06-20-1',
    };
