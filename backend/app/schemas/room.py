...
VALID_SYSTEMS = {"cpc", "cpc_party", "spectrum", "c64", "atari8", "atarist", "amiga", "amiga_link", "amiga_aga", "mastersystem", "megadrive", "saturn", "saturn_beetle", "nes", "snes", "pcengine", "playstation", "arcade"}
